...
def update_countdown():
    ...
    if countdown_time_remaining > 0:
        ...
        if countdown_time_remaining  == 5:
            ...
            label_system_check = customtkinter.CTkLabel(master=root, text="SYSTEM CHECK FINISHED", text_color="green", font=("Roboto", 11))
            label_system_check.pack(pady=0, padx=5, side='right') 
        
    else:
        countdown_label.configure(text="IGNITION!")
        #countdown_complete = True  # Mark countdown as complete
   # if countdown_time_remaining == 5:
   #     label_system_check = customtkinter.CTklabel(master=frame, text="SYSTEM CHECK FINISH", font=("Roboto", 10))
   #     label_system_check.pack(pady=5, padx=5)
...
def checkingSystem():
    consoleLog = customtkinter.CTkLabel(master=root, text="STARTING SYSTEM CHECK", text_color="green", font=("Roboto", 11))
...
def show_main_page():
    ...
    def update(frame):
        global time_data, countdown_complete
    ...
    countdown_label = customtkinter.CTkLabel(master=root, text=f"Countdown: {COUNTDOWN_TIME} seconds", font=("Roboto", 16))
    ...
    terminalLog = customtkinter.CTkLabel

   # if countdown_time_remaining == 5:
   #     label_system_check = customtkinter.CTkLabel(master=root, text="SYSTEM CHECK FINISH", font=("Roboto", 10))
   #     label_system_check.pack(pady=0)
