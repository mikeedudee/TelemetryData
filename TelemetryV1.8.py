...
def start_countdown():
    global countdown_time_remaining
...
def show_main_page():
    ...
    # Add Start Countdown button
    #start_countdown_button = customtkinter.CTkButton(master=plot_frame, text="Start Countdown", command=start_countdown)
    #start_countdown_button.pack(pady=12)
