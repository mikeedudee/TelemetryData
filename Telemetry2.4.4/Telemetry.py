...
UPDATE_INTERVAL = 0.1
#WINDOW_SIZE    = 30 * 60
COUNTDOWN_TIME  = 22 # Countdown time in seconds
consoleValueID  = 1007
...
class LoginFrame:
    ...
    def create_login_page():
        ...
        versionLabel   = customtkinter.CTkLabel(master=frame, text="version 2.4.4 — stable-beta (under development)", font=("Inter", 10))
